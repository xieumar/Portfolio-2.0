...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-white dark:bg-gray-900 pt-16 pb-8 border-t border-gray-100 dark:border-gray-800 overflow-hidden">
      {/* Background Interactive Pastel Bubbles */}
      <InteractiveBubbles count={24} safeCenter={true} className="opacity-80" />
